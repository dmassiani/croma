  ...
  <div class="bg relative bg-gray-50" :style="getGlobalColors()">
        ...
        <svg width="713px" height="663px" viewBox="0 0 713 663" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <g transform="translate(591.000000, 126.000000) rotate(-165.000000) translate(-591.000000, -126.000000) translate(511.000000, 45.000000)">
                    <circle :style="getVariantFill(1,11)" class="filler" cx="77" cy="84" r="67.9"></circle>
                    <path :style="getVariantFill(1,7)" class="filler" d="M126.693815,37.7293704 C137.989525,49.8553918 144.9,66.1206819 144.9,84 C144.9,114.863813 124.307685,140.918034 96.1127409,149.172975 C92.4456596,147.004322 89.7079313,143.102575 87.8978516,137.467969 C80.3376055,113.933641 91.6166382,105.766612 104.148275,97.4325831 L105.364334,96.6250214 C112.677066,91.7702657 120.220844,86.6902583 124.552832,78.3439453 C132.013479,63.9697395 133.353343,50.6499992 126.921237,38.1652777 Z"></path>
                    <path :style="getVariantFill(1,9)" class="filler" d="M143.275215,69.1679366 C144.338932,73.9419663 144.9,78.9054609 144.9,84 C144.9,89.0232408 144.354526,93.9190793 143.31958,98.6315137 C141.64371,103.536936 139.196631,109.110525 135.806836,115.810352 C119.712305,147.620703 101.549219,127.923633 123.055497,112.525 C137.679767,102.05393 143.761337,86.0803698 143.296835,69.8548704 Z"></path>
                    <path :style="getVariantFill(1,13)" class="filler" d="M77,16.1 C81.6192383,16.1 86.1307433,16.561261 90.4909677,17.4402357 C107.586665,21.7034635 120.794713,31.0518991 122.92793,47.3280819 C126.784766,76.7552734 41.846875,57.0664062 49.7177734,124.165234 C51.7899168,141.830104 66.268153,150.431257 93.1524818,149.968693 C87.9798165,151.229757 82.5681801,151.9 77,151.9 C39.4998655,151.9 9.1,121.500135 9.1,84 C9.1,46.4998655 39.4998655,16.1 77,16.1 Z"></path>
                    <path :style="getVariantFill(1,15)" class="filler" d="M78.8744141,36.3740234 C67.3326172,44.6865234 -19.8679687,88.7824219 50.6884766,146.544727 L50.8526577,146.682772 C26.3321292,136.442448 9.1,112.233614 9.1,84 C9.1,58.5352318 23.117981,36.3445384 43.858207,24.7236559 C45.2978506,24.2683303 46.8504914,23.6596122 48.5160156,22.8985637 C70.6740234,12.7736328 90.4162109,28.0615234 78.8744141,36.3740234 Z"></path>
                    <path :style="getVariantFill(1,17)" class="filler" d="M62.0839844,25.5486328 C67.4071274,29.7322266 70.3035156,34.125 52.9798828,44.6140625 C35.65625,55.103125 26.9007812,66.4289063 23.1806641,75.2144531 C19.4605469,84 6.4421875,82.6191406 12.9513672,62.1755859 C13.4759598,60.527984 13.9652627,59.0024243 14.4297541,57.5845643 C18.9868518,46.8039066 26.2483451,37.445572 35.3639713,30.3597255 C35.6369931,30.1811445 35.9142762,29.9990973 36.1962891,29.8142578 C51.8560547,19.5503874 56.7608414,21.3650391 62.0839844,25.5486328 Z"></path>
                    <ellipse :style="getVariantFill(1,19)" class="filler" transform="translate(45.230838, 34.718686) rotate(-31.000000) translate(-45.230838, -34.718686) " cx="45.2308376" cy="34.7186858" rx="12.25" ry="7.35"></ellipse>
                    <ellipse :style="getVariantFill(1,21)" class="filler" transform="translate(45.840706, 31.418682) rotate(-31.000000) translate(-45.840706, -31.418682) " cx="45.8407059" cy="31.4186816" rx="5.95" ry="3.325"></ellipse>
    ...
    <div class="py-12">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="lg:text-center">
          <h2 :style="secondaryColorsText" class="text text-base text-indigo-600 font-semibold tracking-wide uppercase">Transactions</h2>
          <p :style="primaryColorsText" class="text mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
    ...
    <div class="relative py-16 sm:py-24 lg:py-32">
      <div class="mx-auto max-w-md px-4 text-center sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl">
        <h2 :style="secondaryColorsText" class="text text-base font-semibold tracking-wider text-indigo-600 uppercase">Deploy faster</h2>
        <p :style="primaryColorsText" class="text mt-2 text-3xl font-extrabold text-gray-900 tracking-tight sm:text-4xl">
